...
OPTIONS=enable-shared enable-zlib-dynamic -Wa,--noexecstack no-ec_nistp_64_gcc_128 no-gmp no-jpake no-krb5 no-libunbound no-md2 no-rc5 no-rfc3779 no-sctp no-ssl-trace no-store no-unit-test no-static-engine
CONFIGURE_ARGS=linux-x86_64 shared zlib-dynamic -Wa,--noexecstack
